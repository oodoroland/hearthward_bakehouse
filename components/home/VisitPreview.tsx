    ...
    <section className="py-section-padding px-6 lg:px-12 bg-surface">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-space-2xl items-center">
        ...
        <div className="lg:col-span-6">
          {/* TODO: replace with a real embedded map */}
          <div className="w-full h-[400px] rounded-2xl overflow-hidden shadow-lg bg-surface-container-high flex flex-col items-center justify-center gap-2 text-on-surface-variant">
            <MapPin size={32} />
